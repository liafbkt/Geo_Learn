...
> 更新：2026-08-27；分支：`codex/user-test-mvp`；阶段：Tasks 1–6 已完成并通过独立审查，下一步 Task 7。
...
| Tasks 7–16 | 未开始 | 下一步 Task 7，按依赖顺序执行 |
...
- Task 6 最终证据：完整 Vitest 11 文件/166 测试、`pnpm typecheck`、`pnpm lint`、`pnpm build`；详见上述 report。
...
1. Task 7：repository 与 SQLite 事务；Task 8：备份合并/替换。
